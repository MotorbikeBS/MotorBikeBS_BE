...
namespace API.Controllers
{
    ...
    public class PaymentStatisticController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("GetToalInMonthByStore")]
        [Authorize(Roles ="Admin")]
        public async Task<IActionResult>GetToalInMonthByStore(int year, int? storeId)
        {
            try
            {
        ...
        //[HttpGet]
        //[Route("GetToalInYearByStore")]
        //[Authorize(Roles = "Admin")]
        //public async Task<IActionResult>GetToalInYearByStore(int year, int storeId)
        //{
        //    try
        //    {
        //        if (year < 2023 || year > DateTime.Now.Year || year == default || storeId == default)
        //        {
        //            _response.IsSuccess = false;
        //            _response.StatusCode = HttpStatusCode.BadRequest;
        //            _response.ErrorMessages.Add("Vui lòng nhập thông tin hợp lệ!");
        ...
        //            if (paymentRequest.Any())
        //            {
        //                sum = (decimal)paymentRequest.Sum(s => s.Payments.Sum(y => y.Amount));
        //            }
        //            PaymentStatisticResponseDTO response = new()
        //            {
        //                //Amount = sum
